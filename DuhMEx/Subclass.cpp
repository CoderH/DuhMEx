...
void CSubclassWnd::SetRedraw(BOOL bRedraw /*= TRUE*/)
{
...
{
   ::ClientToScreen(m_hWnd, (LPPOINT)pRect);
   ::ClientToScreen(m_hWnd, ((LPPOINT)pRect) + 1);
}

void CSubclassWnd::ScreenToClient(LPRECT pRect)
{
   ::ScreenToClient(m_hWnd, (LPPOINT)pRect);
